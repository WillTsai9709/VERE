      ...
      <div className="absolute inset-0 flex items-end z-20">
        <div className="container mx-auto px-4 pb-20">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8">Indie pop music producer, mixing engineer, and performing artist. Blending warm and rich texture, creating an emotional atmosphere.</p>
            <p className="text-lg md:text-xl text-gray-200 mb-8">獨立流行音樂製作人、混音兼表演藝術家。融合溫暖而豐富的質感，營造出情緒的氛圍。</p>
